...
CREATE SEQUENCE "accounts_id_seq" INCREMENT 1 START 18 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "accounts_id_seq" OWNER TO "postgres";
DROP SEQUENCE IF EXISTS "data_nodes_id_seq";
CREATE SEQUENCE "data_nodes_id_seq" INCREMENT 1 START 18 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
